...
# manually copy over your .extra file (not in the repo for privacy)
...
When setting up a new Mac, you may want to install some common [Python](https://pypi.org/project/pip/) packages (after installing pip, of course):
